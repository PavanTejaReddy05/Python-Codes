...
calculated  through  a  user-defined  function 
cal_sum_prod( ).'''
...
return a  list containing  tuples  of the form (x, x^2, x^3) 
...
def ispal(st):
    ...
    if rev_st==st:
        ...
        print("Givem String is not a Palindrome")
